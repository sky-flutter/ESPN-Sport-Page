...
import 'package:flutter_espn_sport/utils/CustomBorder.dart';
import 'package:flutter_espn_sport/utils/CustomColors.dart';
import 'package:flutter_espn_sport/utils/CustomTextStyle.dart';
import 'package:flutter_espn_sport/utils/CustomUtils.dart';
...
class _HomePageState extends State<HomePage> {
          ...
          children: <Widget>[
            ...
            ConstrainedBox(
              ...
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                itemBuilder: (context, index) {
                  return createMostBigListItem(listShoesImage[index], index,context);
                },
                itemCount: listShoesImage.length,
              ),
            ),
  ...
  createMostBigListItem(String image, int index,BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTap: (){
        Navigator.of(context).push(new MaterialPageRoute(builder: (context)=>ProductDetailsPage()));
      },
    );
  }
}
